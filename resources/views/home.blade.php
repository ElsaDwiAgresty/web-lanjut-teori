...
@section('content')
    <style>
        ...
        /* New styles */
        h3, h4 {
            font-family: 'Arial', sans-serif; /* Mengubah font untuk judul */
            margin-bottom: 20px;
        }

        .reservasi-info {
            margin-bottom: 40px; /* Memberi jarak antara waktu reservasi dan menu */
        }
    </style>
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                <ul class="navbar-nav ml-auto">
                    @if (session('id_pelanggan'))
                        <li class="nav-item">
                            <a class="nav-link" href="{{ session('role') == 'pelanggan' ? route('pelanggan.dashboard') : route('admin.dashboard') }}">
    ...
    <div class="container my-4">
        ...
        <div class="row mb-5">
            <div class="col-md-6">
                ...
                <p>Selamat datang di restoran kami, tempat yang sempurna untuk menikmati makanan lezat bersama teman dan keluarga. Kami menawarkan berbagai hidangan yang terbuat dari bahan berkualitas tinggi dan disiapkan oleh chef berpengalaman.</p>
                <p>Untuk reservasi, silakan klik tombol di bawah ini untuk memulai proses reservasi Anda.</p>
                <a href="{{ session('role') == 'pelanggan' ? route('pelanggan.reservasi.create') : route('login') }}" class="btn btn-primary">
                    Buat Reservasi
                </a>
            </div>
            <div class="col-md-6">
...
<div class="row g-3 mt-4">
    @php
        $jenisReservasi = [
            ['nama' => 'VIP', 'gambar' => 'img/VipRoom.jpg', 'deskripsi' => 'Reservasi eksklusif dengan pelayanan istimewa.'],
            ['nama' => 'Couple', 'gambar' => 'img/CoupleRoom.jpg', 'deskripsi' => 'Ciptakan suasana romantis bersama pasangan.'],
            ['nama' => 'Family', 'gambar' => 'img/FamilyRoom.jpg', 'deskripsi' => 'Nyaman untuk berkumpul bersama keluarga.'],
            ['nama' => 'Group', 'gambar' => 'img/GroupRoom.jpg', 'deskripsi' => 'Ideal untuk acara bersama teman atau kolega.'],
            ['nama' => 'Business', 'gambar' => 'img/BusinessRoom.jpg', 'deskripsi' => 'Lingkungan profesional untuk pertemuan bisnis.'],
        ];
    @endphp
    ...
    @foreach ($jenisReservasi as $reservasi)
        <div class="col-12 col-md-6 col-lg-2 mb-4 d-flex justify-content-center">
            <div class="card menu-card w-100">
                ...
                <img src="{{ asset($reservasi['gambar']) }}" class="card-img-top" alt="{{ $reservasi['nama'] }}" style="height: 180px; object-fit: cover;">
                <div class="card-body">
    ...
    @endforeach
        ...
        <div class="d-flex flex-wrap justify-content-center gap-3 reservasi-info">
            @foreach (['13.00', '14.30', '17.00', '18.00','20.00','20.30'] as $time)
                <div style="width: 150px; text-align: center; border: 1px solid #ddd; padding: 10px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
                    <h4>{{ $time }}</h4>
                </div>
            @endforeach
        </div>
